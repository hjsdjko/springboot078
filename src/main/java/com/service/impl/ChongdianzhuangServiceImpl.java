...
public class ChongdianzhuangServiceImpl extends ServiceImpl<ChongdianzhuangDao, ChongdianzhuangEntity> implements ChongdianzhuangService {
    ...
    @Override
    public List<Map<String, Object>> selectValue(Map<String, Object> params, Wrapper<ChongdianzhuangEntity> wrapper) {
        return baseMapper.selectValue(params, wrapper);
    }

    @Override
    public List<Map<String, Object>> selectTimeStatValue(Map<String, Object> params, Wrapper<ChongdianzhuangEntity> wrapper) {
        return baseMapper.selectTimeStatValue(params, wrapper);
    }

    @Override
    public List<Map<String, Object>> selectGroup(Map<String, Object> params, Wrapper<ChongdianzhuangEntity> wrapper) {
