...
public class WuyejiaofeiController {
    ...
    public R value(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName,HttpServletRequest request) {
        ...
        List<Map<String, Object>> result = wuyejiaofeiService.selectValue(params, ew);
    ...
    public R valueDay(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName, @PathVariable("timeStatType") String timeStatType,HttpServletRequest request) {
        ...
        List<Map<String, Object>> result = wuyejiaofeiService.selectTimeStatValue(params, ew);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        for(Map<String, Object> m : result) {
            for(String k : m.keySet()) {
                if(m.get(k) instanceof Date) {
    ...
    public R group(@PathVariable("columnName") String columnName,HttpServletRequest request) {
        ...
        List<Map<String, Object>> result = wuyejiaofeiService.selectGroup(params, ew);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        for(Map<String, Object> m : result) {
            for(String k : m.keySet()) {
                if(m.get(k) instanceof Date) {
    ...
    public R count(@RequestParam Map<String, Object> params,WuyejiaofeiEntity wuyejiaofei, HttpServletRequest request){
        String tableName = request.getSession().getAttribute("tableName").toString();
        if(tableName.equals("yezhu")) {
            wuyejiaofei.setYezhuzhanghao((String)request.getSession().getAttribute("username"));
        }
        EntityWrapper<WuyejiaofeiEntity> ew = new EntityWrapper<WuyejiaofeiEntity>();
        int count = wuyejiaofeiService.selectCount(MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, wuyejiaofei), params), params));
