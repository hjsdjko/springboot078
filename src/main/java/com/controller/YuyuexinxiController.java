...
public class YuyuexinxiController {
    ...
    public R save(@RequestBody YuyuexinxiEntity yuyuexinxi, HttpServletRequest request){
        if(yuyuexinxiService.selectCount(new EntityWrapper<YuyuexinxiEntity>().eq("dianzhuangbianhao", yuyuexinxi.getDianzhuangbianhao()))>0) {
            return R.error("电桩编号已存在");
        }
    ...
    public R update(@RequestBody YuyuexinxiEntity yuyuexinxi, HttpServletRequest request){
        //ValidatorUtils.validateEntity(yuyuexinxi);
        if(yuyuexinxiService.selectCount(new EntityWrapper<YuyuexinxiEntity>().ne("id", yuyuexinxi.getId()).eq("dianzhuangbianhao", yuyuexinxi.getDianzhuangbianhao()))>0) {
            return R.error("电桩编号已存在");
        }
